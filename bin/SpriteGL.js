...
(function (SpriteGL) {
    ...
    SpriteGL.Shader = Shader;
})(SpriteGL || (SpriteGL = {}));

var SpriteGL;
(function (SpriteGL) {
    var SpriteRenderer = (function () {
        function SpriteRenderer(webglContext, Image) {
            this.gl = webglContext;
            this.vbo = new SpriteGL.VBO(this.gl);
            this.Shader = new SpriteGL.Shader(this.gl);
        ...
        SpriteRenderer.prototype.CreateTexture = function (image) {
    ...
    SpriteGL.SpriteRenderer = SpriteRenderer;
})(SpriteGL || (SpriteGL = {}));
...
var TextDrawer = (function () {
    ...
    TextDrawer.prototype.UpdatePositon = function () {
        this.txtsList.sort(function (a, b) {
